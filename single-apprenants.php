...
<article id="page-apprenant">
    ...
    <div class="slideshow">
        <div class="mySlides fade">
            ...
            <img class="ahAh" src="./Jarod.png" alt="">
        </div>
        <div class="mySlides fade">
            <div class="arrettxt">
                <h1>Andy</h1>
            ...
            <img class="ahAh" src="./Andy.png" alt="">
        </div>
        <div class="mySlides fade">
            <div class="arrettxt">
                <h1>Tiffany</h1>
            ...
            <img class="ahAh" src="./Tiff.png" alt="">   
        </div>
        <div class="mySlides fade">  
            <div class="arrettxt">
                <h1>Xhesika</h1>
            ...
            <img class="ahAh" src="./Xhesika.png" alt="">
        ...
        <div class="mySlides fade">
            ...
            <img class="ahAh" src="./André.png" alt="">
        </div>
        <div class="mySlides fade">
            <div class="arrettxt">
                <h1>Nathan</h1>
            ...
            <img class="ahAh" src="./Nathan.png" alt="">
        </div>
        <div class="mySlides fade">
            <div class="arrettxt">
                <h1>Lilian</h1>
            ...
            <img class="ahAh" src="./Lilian.png" alt="">
        </div>
